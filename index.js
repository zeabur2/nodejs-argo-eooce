...
const UUID = process.env.UUID || 'a3e92080-b172-4053-bbf1-c9ffcfcf002e';
...
const NEZHA_KEY = process.env.NEZHA_KEY || 'KoCFtCU0UTt91Uyxlg'; // 哪吒客户端密钥
const ARGO_DOMAIN = process.env.ARGO_DOMAIN || 'lade3.hani.nyc.mn'; // 固定隧道域名，留空即启用临时隧道
const ARGO_AUTH = process.env.ARGO_AUTH || 'eyJhIjoiMzU4YzRkOThmODlkZmE4MTAyZTBiYTI0ZmI1NWJiMmMiLCJ0IjoiMjVmN2RjMzQtODhmMi00YjFkLThjMTgtYTYwYWJhNTY4NzI2IiwicyI6Ik5qQTFOMlkyWkRVdFltUXhZUzAwWW1JeUxXRmlOVFl0WkRJd01EVm1OVEUyT1RRNSJ9'; // 固定隧道json或token，留空即启用临时隧道
const CFIP = process.env.CFIP || 'www.visa.com.tw'; // 优选域名或优选ip
const CFPORT = process.env.CFPORT || 443; // 节点端口
const NAME = process.env.NAME || 'Vls'; // 节点名称
const ARGO_PORT = process.env.ARGO_PORT || 8000; // Argo端口，使用固定隧道token需和cf后台设置的端口对应
